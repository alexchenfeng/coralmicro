...
#define _Z_CHANNEL_DEFINE(item_name, kind_name)                                                             \
    _Z_CHANNEL_DEFINE_IMPL(_z_##kind_name##_handler_##item_name##_t,                                                \
                           kind_name##_handler_##item_name,                                                          \
                           z_##kind_name##_channel_##item_name##_new,                                                \
                           z_owned_closure_##item_name##_t,                                                          \
                           z_closure_##item_name,                                                                    \
                           _z_##kind_name##_mt_t,                                                                    \
                           _z_##kind_name##_mt_init,                                                                 \
                           _z_##kind_name##_mt_clear,                                                                \
                           _z_##kind_name##_mt_push,                                                                 \
                           _z_##kind_name##_mt_pull,                                                                 \
                           _z_##kind_name##_mt_try_pull,                                                             \
                           _z_##kind_name##_mt_close,                                                                \
                           z_owned_##item_name##_t,                                                                  \
                           z_loaned_##item_name##_t,                                                                 \
                           z_##item_name##_take_from_loaned,                                                         \
                           z_##item_name##_move,                                                                     \
                           z_##item_name##_drop,                                                                     \
                           z_internal_##item_name##_null)
